...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ServerlessApp*):
...
Execute unit tests
```
    cd "ServerlessApp/test/ServerlessApp.Tests"
    dotnet test
```

Deploy application
```
    cd "ServerlessApp/src/ServerlessApp"
